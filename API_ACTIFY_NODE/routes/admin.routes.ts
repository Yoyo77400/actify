...
adminRouter.get('/assets/:id', adminController.getAsset)
adminRouter.put('/assets/:id', adminController.updateAsset)
...
adminRouter.put('/reports/:id/resolve', adminController.resolveReport)
